...
namespace Odering.Application.Common.Interface
{
    public interface IIdentityService
    {

        //User section
        Task<(bool isSucceed, string usedId)> CreateUserAsync(string userName, string password,string email,string fullName,List<string> roles);
